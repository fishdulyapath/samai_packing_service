package SamaiPackingServiceAPI;
...
@Path("v1")
public class SamaiPackingServiceAPI {
...
//            System.out.println("query " + query);
            ...
            String query1 = "select doc_no, "
                    ...
                    + "    so_qty, "
                    + "    remark, "
                    + "    line_number from krp_trans_detail where doc_no = '" + __doc_no + "' order by line_number";
    ...
    public Response sendApprove(
        ...
        try {
            ...
            String __strQUERY1 = "update krp_trans set status=1 WHERE doc_no ='" + strDocno + "' ;";
            System.out.println("__strQUERY1");
            Statement __stmt1;
    ...
    public Response sendCloseJob(
        ...
        try {
            ...
            String __strQUERY1 = "update krp_trans set status=2 WHERE doc_no ='" + strDocno + "' ;";
            System.out.println("__strQUERY1");
            Statement __stmt1;
    ...
    public Response getPermission(
        ...
        try {
            ...
            String __strQUERY1 = "select code,name_1,coalesce((select receive_screen from krp_permission where upper(user_code) = upper(code)),0) as receive_screen, "
                    + "coalesce((select admin_screen from krp_permission where upper(user_code) = upper(code)),0) as admin_screen, "
                    + "coalesce((select history_screen from krp_permission where upper(user_code) = upper(code)),0) as history_screen "
    ...
    public Response upDatePermission(
        ...
        try {
            ...
            __stmt1 = __conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_UPDATABLE);
            ResultSet __rsHead = __stmt1.executeQuery("select user_code from krp_permission where user_code = '" + user_code + "'");
            ...
            if (row > 0) {
                ...
                __stmtdelete.executeUpdate("delete from krp_permission where user_code = '" + user_code + "';");
            }

            __query_builder.append("INSERT INTO krp_permission (user_code,receive_screen,admin_screen,history_screen) values ('" + user_code + "','" + receive_screen + "','" + admin_screen + "','" + history_screen + "');");
    ...
    public Response deleteReceiveDoc(
        ...
        try {
            ...
            String __strQUERY1 = "delete FROM krp_trans WHERE doc_no ='" + strDocno + "' ;"
                    + " delete FROM krp_trans_detail WHERE doc_no ='" + strDocno + "' ;";
            System.out.println("__strQUERY1");
            Statement __stmt1;
    ...
    public Response saveCartSubDetail(
        ...
        try {
            ...
            String __strQUERY1 = "select doc_no from krp_trans where doc_no='" + docno + "' ";
            ...
            if (row == 0) {
                String __strQUERYz = "INSERT INTO krp_trans ( "
                        + "    doc_no, "
                        + "    doc_date, "
                        + "    doc_time, "
                        + "    wh_code, "
    ...
    public Response updateReceiveDoc(
        ...
        try {
            ...
            __stmtDelete.executeUpdate("delete from krp_trans_detail where doc_no = '" + docno + "';");
            __stmtDelete.close();

            for (int i = 0; i < details.length(); i++) {
                JSONObject objJSDataItem = details.getJSONObject(i);
                _queryDetail.append("insert into krp_trans_detail (doc_no, "
                        + "    barcode, "
                        + "    item_year, "
                        + "    item_code, "
                        + "    unit_code, "
